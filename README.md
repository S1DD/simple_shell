...
This project is a simple implementation of a command-line shell program in C. The shell allows users to execute commands, handle input and output redirection, and manage basic built-in commands. It serves as a learning tool for understanding shell operations and command execution in Unix-like systems.
...
```c
git clone https://github.com/S1DD/simple_shell.git
```

- SSH:

```
git clone git@github.com:S1DD/simple_shell.git
```
...
```shell
Hell_Shell>> ls
AUTHORS  Hell_Shell  README.md aux_functions.c  create_child.c  dir  execute.c  free_mem.c  generateAUTHORS  man_1_simple_shell  shell.h shell_init.c  tokenize.c
```
...
-rw-rw-r-- 1 vagrant vagrant  1682 Apr 15 23:17 aux_functions.c
...
```
Note that in the second line the *Ctrl+C*  is typed
